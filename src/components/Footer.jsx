            ...
            <div className="p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap" style={{ color: '#1E1E1E' }}>Flowbite</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold uppercase" style={{ color: '#1E1E1E' }}>Follow us</h2>
                            <ul className="font-medium" style={{ color: '#1E1E1E' }}>
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="#" className="hover:text-gray-900 me-5" style={{ color: '#1E1E1E' }}>
